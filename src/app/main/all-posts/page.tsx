      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-gray-900">全ての投稿</h1>
            <Link
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6 bg-white rounded-xl shadow-lg p-6 border-2 border-emerald-200">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm text-gray-600">全ての投稿</p>
          ...
          {!posts || posts.length === 0 ? (
            <div className="text-center py-16 bg-white rounded-2xl shadow-xl">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">まだ投稿がありません</h2>
              <p className="text-gray-600 mb-6">最初の投稿を作成してみましょう！</p>
              <Link
                href="/main/posts/create"
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="flex gap-3">
                      <Link
                        href={`/main/posts/${post.id}`}
                        className="flex-1 text-center px-4 py-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white rounded-lg font-semibold transition-all duration-200 flex items-center justify-center gap-2"
                      >
